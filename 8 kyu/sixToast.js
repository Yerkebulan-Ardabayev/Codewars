...
//   Примеры:
// Вы должны вернуть количество тостов, которое вам нужно положить(или вынуть).В случае, если 5 вы все еще можете положить 1тост в:

// six_toast(5) == 1
// И на случай, если 12вам нужно 6меньше тостов(но не - 6):
